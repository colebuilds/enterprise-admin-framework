...
<template>
  <div class="account-table">
    <div class="account-table__header">
      ...
      <span class="account-table__col account-table__col--field">{{ t('system.sysUser.create.account') }}
        <span class="text-[#d03050]">*</span></span>
      <span class="account-table__col account-table__col--field">{{ t('system.sysUser.create.name') }}
        <span class="text-[#d03050]">*</span></span>
      <span class="account-table__col account-table__col--pwd">{{ t('system.sysUser.create.password') }}
        <span class="text-[#d03050]">*</span></span>
