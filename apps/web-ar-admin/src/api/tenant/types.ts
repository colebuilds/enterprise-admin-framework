 ...
 * @name: AddCountryReq
 */
export interface AddCountryReq {
  /**
   * 国家代码
   */
  countryCode: string;
...
/**
 * @description: 新增集团 (Auth) 请求
 * @url: /api/Organization/Add
 * @name: AddOrganizationReq
 */
...
/**
 * @description: 新增商户 (Auth) 响应
 * @url: /api/Tenant/Add
 * @name: AddTenantRsp
 */
export interface AddTenantRsp {
  /**
   * 商户ID
   */
  tenantId: number;
...
export type AddTenantRspApiResponse = AddTenantRsp;
...
/**
 * @description: 获取商户V3模式状态 (Auth) 响应
...
/**
 * @description: 获取可新增的国家列表 (Auth) 响应
...
/**
 * @description: 按CountryCode查询 (Auth) 请求
 * @url: /api/Country/Get
 * @name: CountryGetReq
 */
export interface CountryGetReq {
  /**
   * 国家编码
   */
  countryCode: string;
...
/**
 * @description: 按CountryCode查询 (Auth) 响应
 * @url: /api/Country/Get
 * @name: CountryModelRsp
 */
export interface CountryModelRsp {
  /**
   * 国家编码
   */
  countryCode: string;
...
export type CountryModelRspApiResponse = CountryModelRsp;

/**
 * @description: 查询国家列表 (Auth) 响应
 * @url: /api/Country/GetPageList
 * @name: CountryModelRspListPageBaseResponse
 */
export interface CountryModelRspListPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: CountryModelRsp[];
  /**
   * 当前页
   */
  pageNo: number;
...
export type CountryModelRspListPageBaseResponseApiResponse = CountryModelRspListPageBaseResponse;

/**
 * @description: 按CurrencyCode查询 (Auth) 请求
 * @url: /api/Currency/Get
 * @name: CurrencyGetReq
 */
export interface CurrencyGetReq {
  /**
   * 币种编码
   */
  currencyCode: string;
...
/**
 * @description: 查询币种列表 (Auth) 请求
 * @url: /api/Currency/GetPageList
 * @name: CurrencyListReq
 */
...
/**
 * @description: 按CurrencyCode查询 (Auth) 响应
 * @url: /api/Currency/Get
 * @name: CurrencyModelRsp
 */
export interface CurrencyModelRsp {
  /**
   * 币种编码
   */
  currencyCode: string;
...
export type CurrencyModelRspApiResponse = CurrencyModelRsp;

/**
 * @description: 查询币种列表 (Auth) 响应
 * @url: /api/Currency/GetPageList
 * @name: CurrencyModelRspListPageBaseResponse
 */
export interface CurrencyModelRspListPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: CurrencyModelRsp[];
  /**
   * 当前页
   */
  pageNo: number;
...
export type CurrencyModelRspListPageBaseResponseApiResponse = CurrencyModelRspListPageBaseResponse;

/**
 * @description: 删除集团 (Auth) 请求
...
export interface FiatCurrencyTenantItemRsp {
  /**
   * 币种编码
   */
  currencyCode: string;
...
/**
 * @description: 获取币种及商户列表 (Auth) 响应
 * @url: /api/Tenant/GetFiatCurrencyList
 * @name: FiatCurrencyTenantRsp
 */
export interface FiatCurrencyTenantRsp {
  /**
   * 币种对应商户列表
   */
  currencyTenantList: FiatCurrencyTenantItemRsp[];
}

export type FiatCurrencyTenantRspApiResponse = FiatCurrencyTenantRsp;

/**
 * @description: 获取集团详情 (Auth) 请求
 * @url: /api/Organization/Get
 * @name: GetOrganizationReq
 */
export interface GetOrganizationReq {
  /**
   * 集团ID
   */
  id: number;
...
/**
 * @description: 按LanguageCode查询 (Auth) 请求
 * @url: /api/Language/Get
 * @name: LanguageGetReq
 */
export interface LanguageGetReq {
  /**
   * 语言代码
   */
  languageCode: string;
...
/**
 * @description: 查询语言列表 (Auth) 请求
 * @url: /api/Language/GetPageList
 * @name: LanguageListReq
 */
...
/**
 * @description: 按LanguageCode查询 (Auth) 响应
 * @url: /api/Language/Get
 * @name: LanguageModelRsp
 */
export interface LanguageModelRsp {
  /**
   * 语言编码
   */
  languageCode: string;
...
export type LanguageModelRspApiResponse = LanguageModelRsp;

/**
 * @description: 查询语言列表 (Auth) 响应
 * @url: /api/Language/GetPageList
 * @name: LanguageModelRspListPageBaseResponse
 */
export interface LanguageModelRspListPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: LanguageModelRsp[];
  /**
   * 当前页
   */
  pageNo: number;
...
export type LanguageModelRspListPageBaseResponseApiResponse = LanguageModelRspListPageBaseResponse;

/**
 * @description: 获取商户V3模式状态 (Auth) 请求
 * @url: /api/Tenant/GetV3Mode
...
/**
 * @description: 获取集团详情 (Auth) 响应
 * @url: /api/Organization/Get
 * @name: OrganizationDetailRsp
 */
export interface OrganizationDetailRsp {
  /**
   * 集团ID
   */
  id: number;
...
export type OrganizationDetailRspApiResponse = OrganizationDetailRsp;

/**
 * @description: 分页获取集团列表 (Auth) 请求
 * @url: /api/Organization/GetPageList
 * @name: OrganizationPageListReq
 */
export interface OrganizationPageListReq {
  /**
   * 集团名称（模糊查询）
   */
  name?: string;
...
export interface OrganizationPageListRsp {
  /**
   * 集团ID
   */
  id: number;
...
/**
 * @description: 分页获取集团列表 (Auth) 响应
 * @url: /api/Organization/GetPageList
 * @name: OrganizationPageListRspListPageBaseResponse
 */
export interface OrganizationPageListRspListPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: OrganizationPageListRsp[];
  /**
   * 当前页
   */
  pageNo: number;
...
export type OrganizationPageListRspListPageBaseResponseApiResponse = OrganizationPageListRspListPageBaseResponse;

export interface OrganizationSelectRsp {
  /**
   * 集团ID
   */
  id: number;
...
/**
 * @description: 获取集团下拉列表（新增商户时使用） (Auth) 响应
 * @url: /api/Organization/GetSelectList
 * @name: OrganizationSelectRspListApiResponse
 */
export type OrganizationSelectRspListApiResponse = OrganizationSelectRsp[];

export interface OwnerTenantInfo {
  /**
   * 
   */
  tenantId?: number;
...
/**
 * @description: 获取所属租户信息 (Auth) 响应
 * @url: /api/Tenant/GetOwnerTenantList
 * @name: OwnerTenantInfoListApiResponse
 */
export type OwnerTenantInfoListApiResponse = OwnerTenantInfo[];

/**
 * @description: 获取币种及商户列表 (Auth) 请求
 * @url: /api/Tenant/GetFiatCurrencyList
 * @name: TenantByFiatCurrencyReq
 */
export interface TenantByFiatCurrencyReq {
  /**
   * 
   */
  currencyType?: TenantWithdrawCurrencyTypeEnum;
  /**
   * 商户Id列表
   */
  tenantIds?: number[];
...
/**
 * @description: 获取所属租户信息 (Auth) 请求
 * @url: /api/Tenant/GetOwnerTenantList
 * @name: TenantChildReq
 */
export type TenantChildReq = Record<string, unknown>;

/**
 * @description: 更新商户信息 (Auth) 请求
...
export interface TenantRsp {
  ...
  timeZone: string;
  /**
   * 密钥(对应GameSaas系统的商户密钥)
   */
  secretKeyGameSaas: string;
  /**
   * 后台域名
   */
  adminDomain: string;
...
/**
 * @description: 获取商户信息列表（带分页） (Auth) 响应
 * @url: /api/Tenant/GetPageList
 * @name: TenantRspListPageBaseResponse
 */
export interface TenantRspListPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: TenantRsp[];
...
export type TenantRspListPageBaseResponseApiResponse = TenantRspListPageBaseResponse;

/**
 * @description: 获取商户信息列表（带分页） (Auth) 请求
 * @url: /api/Tenant/GetPageList
 * @name: TenantSearchReq
 */
export interface TenantSearchReq {
  /**
   * 商户主键、非自增，1001开始
   */
  tenantId?: number;
...
/**
 * @description: 商户下拉列表 (Auth) 请求
 * @url: /api/Tenant/GetSelectList
 * @name: TenantSelectReq
 */
export interface TenantSelectReq {
  /**
   * 是否过滤已关站商户，默认不过滤
   */
  isFilterStoppedTenant?: boolean;
}
...
/**
 * @description: 修改商户备注 (Auth) 请求
 * @url: /api/Tenant/UpdateTenantRemark
 * @name: TenantUpdateRemarkReq
 */
export interface TenantUpdateRemarkReq {
  /**
   * 商户ID
   */
  tenantId: number;
...
/**
 * @description: 修改商户状态（关站时强制退出所有相关后台账号） (Auth) 请求
 * @url: /api/Tenant/SwitchTenantState
 * @name: TenantUpdateStateReq
 */
export interface TenantUpdateStateReq {
  /**
   * 商户ID
   */
  tenantId: number;
...
/**
 * @description: 设置商户V3模式开关 (Auth) 请求
 * @url: /api/Tenant/SetV3Mode
 * @name: TenantV3ModeReq
 */
export interface TenantV3ModeReq {
  /**
   * 
   */
  isV3Mode: EnableEnum;
...
/**
 * @description: 1 - 法币 2 - USDT
 */
export type TenantWithdrawCurrencyTypeEnum = "法币" | "USDT";
...
/**
 * @description: 更新集团状态（启用/禁用，禁用时强制退出集团所有后台账号） (Auth) 请求
 * @url: /api/Organization/UpdateState
 * @name: UpdateOrganizationStateReq
 */
export interface UpdateOrganizationStateReq {
  /**
   * 集团ID
   */
  id: number;
