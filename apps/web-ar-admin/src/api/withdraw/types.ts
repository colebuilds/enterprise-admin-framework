...
/**
 * @description: 设置今日提现总次数配置(双写V1+V3，刷新V1缓存) (Auth) 响应
...
export interface BankCardDetailRsp {
  /**
   * 银行名称
   */
  bankName: string;
...
/**
 * @description: 获取通道字典可选的系统提现大类枚举列表 (Auth) 请求
...
/**
 * @description: 获取测试币种对应提现类型列表 (Auth) 请求
 * @url: /api/WithdrawChannel/GetTestCurrencyWithdrawType
 * @name: GetTestCurrencyWithdrawTypeReq
 */
export interface GetTestCurrencyWithdrawTypeReq {
  /**
   * 币种
   */
  currency?: string;
...
/**
 * @description: 获取测试提现资料联动信息 (Auth) 请求
 * @url: /api/WithdrawChannel/GetTestWithdrawBankCategoryInfo
 * @name: GetTestWithdrawBankCategoryInfoReq
 */
export interface GetTestWithdrawBankCategoryInfoReq {
  /**
   * 提现大类ID
   */
  type?: number;
...
/**
 * @description: 获取测试提现资料 (Auth) 请求
 * @url: /api/WithdrawChannel/GetTestWithdrawCategory
 * @name: GetTestWithdrawCategoryReq
 */
export interface GetTestWithdrawCategoryReq {
  /**
   * 提现大类ID
   */
  typeId?: number;
...
/**
 * @description: 获取系统提现大类枚举列表(供新增/编辑下拉选择) (Auth) 响应
...
/**
 * @description: 获取提现大类下拉列表(供搜索栏下拉选择) (Auth) 请求
...
/**
 * @description: 获取提现通道新增场景的商户通道树形数据 (Auth) 请求
...
/**
 * @description: 获取提现通道新增场景的商户通道树形数据 (Auth) 响应
 * @url: /api/WithdrawChannel/GetMerchantChannelTree
...
export interface MyAuditOrderListRsp {
  /**
   * 订单号
   */
  orderNo: string;
   ...
   * 
   */
  thirdPartyDetail: ThirdPartyDetailRsp;
  /**
   * 开始审核时间
   */
   ...
   * 
   */
  auditState: WithdrawAuditStateEnum;
  /**
   * 指派人ID
   */
  assignerSysUserId: number;
  /**
   * 指派人名称
   */
  assignerName: string;
...
/**
 * @description: 获取我的待审核订单分页列表 (Auth) 响应
 * @url: /api/WithdrawOrder/GetMyAuditOrderList
 * @name: MyAuditOrderListRspListPageBaseObjResponse
 */
export interface MyAuditOrderListRspListPageBaseObjResponse {
  /**
   * 
   */
  data: any;
...
export type MyAuditOrderListRspListPageBaseObjResponseApiResponse = MyAuditOrderListRspListPageBaseObjResponse;

/**
 * @description: 获取我的待审核订单分页列表 (Auth) 请求
 * @url: /api/WithdrawOrder/GetMyAuditOrderList
 * @name: MyAuditOrderPageReq
 */
export interface MyAuditOrderPageReq {
  /**
   * 
   */
  withdrawAuditState?: WithdrawAuditStateEnum;
  /**
   * 每页数据量大小
   */
  pageSize: number;
...
/**
 * @description: 获取订单池预警配置 (Auth) 响应
 * @url: /api/WithdrawStaticDay/GetOrderPoolWarningConfig
 * @name: OrderPoolWarningConfigRsp
 */
export interface OrderPoolWarningConfigRsp {
  /**
   * 各币种订单池预警配置
   */
  currencyConfigs: OrderPoolWarningCurrencyConfigRsp[];
}

export type OrderPoolWarningConfigRspApiResponse = OrderPoolWarningConfigRsp;

export interface OrderPoolWarningCurrencyConfigItem {
  /**
   * 
   */
  sysCurrency: CurrencyEnum;
  ...
  /**
   * 预警推送频率(分钟)(0=该币种不生效, 上限 24 小时=1440 分钟)
   */
  intervalMinutes?: number;
}

export interface OrderPoolWarningCurrencyConfigRsp {
  /**
   * 
   */
  sysCurrency: CurrencyEnum;
...
/**
 * @description: 刷新出款单状态（主动查询三方订单最新状态） (Auth) 请求
 * @url: /api/WithdrawOrder/RefreshWithdrawState
 * @name: RefreshWithdrawStateReq
 */
export interface RefreshWithdrawStateReq {
  /**
   * 提现订单号
   */
  orderNo: string;
...
/**
 * @description: 保存订单池预警配置（按币种设置待派发订单数预警阈值与推送频率） (Auth) 请求
 * @url: /api/WithdrawStaticDay/SaveOrderPoolWarningConfig
 * @name: SaveOrderPoolWarningConfigReq
 */
export interface SaveOrderPoolWarningConfigReq {
  /**
   * 各币种订单池预警配置
   */
  currencyConfigs: OrderPoolWarningCurrencyConfigItem[];
}

/**
 * @description: 获取出款工作台看板数据 (Auth) 请求
 * @url: /api/WithdrawStaticDay/GetDashboardData
 * @name: SearchTenantIdsRequest
 */
export interface SearchTenantIdsRequest {
  /**
   * 商户Id
   */
  tenantIds?: number[];
...
/**
 * @description: 获取当前系统用户出款工作详情 (Auth) 响应
 * @url: /api/WithdrawUser/GetSysUserWorkDetail
 * @name: SysUserWorkDetailRsp
 */
export interface SysUserWorkDetailRsp {
  /**
   * 
   */
  userRank: WithdrawUserRankEnum;
  /**
   * 所属上级用户Id列表，逗号分割
   */
  parentSysUserIds: string;
  /**
   * 
   */
  approvalConfig: WithdrawApprovalConfig;
  /**
   * 最后上班时间
   */
  lastWorkStartTime: number;
  /**
   * 最后下班时间
   */
  lastWorkEndTime: number;
  /**
   * 出款派单配置组别ID
   */
   ...
   * 
   */
  workState: WithdrawWorkStateEnum;
  /**
   * 
   */
  enableState: IsEnum;
   ...
   * 今日总暂停时长（秒）
   */
  todayPauseDuration: number;
  /**
   * 上次暂停时间（本段暂停起点，未在暂停中则为 0）
   */
  lastPauseStartTime: number;
}

export type SysUserWorkDetailRspApiResponse = SysUserWorkDetailRsp;

/**
 * @description: 代付测试查询订单 (Auth) 请求
 * @url: /api/WithdrawChannel/TestCheckWithdrawOrder
 * @name: TestCheckWithdrawOrderReq
 */
export interface TestCheckWithdrawOrderReq {
  /**
   * 商户通道ID（tab_thirdpay_tenantchannel.Id）
   */
...
/**
 * @description: 代付测试拉单 (Auth) 请求
 * @url: /api/WithdrawChannel/TestCreateWithdrawOrder
 * @name: TestCreateWithdrawOrderReq
 */
export interface TestCreateWithdrawOrderReq {
  /**
   * 操作系统用户ID
   */
...
/**
 * @description: 代付测试查询三方通道余额 (Auth) 请求
 * @url: /api/WithdrawChannel/TestQueryThirdChannelBalance
 * @name: TestQueryThirdChannelBalanceReq
 */
export interface TestQueryThirdChannelBalanceReq {
  /**
   * 商户通道ID（tab_thirdpay_tenantchannel.Id）
   */
  tenantChannelId: number;
...
/**
 * @description: 代付测试回调 (Auth) 请求
 * @url: /api/WithdrawChannel/TestWithdrawNotify
 * @name: TestWithdrawNotifyReq
 */
export interface TestWithdrawNotifyReq {
  /**
   * 商户通道ID（tab_thirdpay_tenantchannel.Id）
   */
  tenantChannelId: number;
...
export interface ThirdPartyDetailRsp {
  /**
   * 三方展示内容
   */
  thirdPayCode: string;
   ...
   * 
   */
  thirdState: ThirdStateEnum;
  /**
   * 三方消息
   */
  thirdMessage: string;
  /**
   * 代付请求次数（每调一次 SubmitThirdPay +1）
   */
  paidOutCount: number;
}

/**
 * @description: 0 - 待提交 1 - 等待回调 2 - 失败 3 - 成功 4 - 异常，待前往三方确认 5 - 提交三方中
 */
export type ThirdStateEnum = 0 | 1 | 2 | 3 | 4 | 5;

/**
 * @description: 修改提现通道状态 (Auth) 请求
...
/**
 * @description: 0 - 正式账号 1 - 测试账号 2 - 游客账号
 */
...
/**
 * @description: 开始派单（管理员） (Auth) 请求
 * @url: /api/WithdrawUser/AdminStartDispatch
 * @name: WithdrawAdminActionReq
 */
export interface WithdrawAdminActionReq {
  /**
   * 系统用户Id
   */
  userId?: number;
...
export interface WithdrawApprovalConfig {
  /**
   * 提现单可审核金额下限
   */
  auditMinAmount?: number;
  /**
   * 提现单可审核金额上限
   */
  auditMaxAmount?: number;
  /**
   * 可同时处理订单上限
   */
  currentProcessingOrderLimit?: number;
}

/**
 * @description: 转派提现订单（支持批量） (Auth) 请求
 * @url: /api/WithdrawUser/AssignOrder
 * @name: WithdrawAssignOrderReq
 */
export interface WithdrawAssignOrderReq {
  /**
   * 提现订单号列表
   */
  orderNos: string[];
...
/**
 * @description: 获取提现订单审核详情 (Auth) 请求
 * @url: /api/WithdrawOrder/GetAuditOrderDetail
 * @name: WithdrawAuditOrderDetailReq
 */
export interface WithdrawAuditOrderDetailReq {
  /**
   * 提现订单号
   */
  orderNo: string;
...
/**
 * @description: 获取提现订单审核详情 (Auth) 响应
 * @url: /api/WithdrawOrder/GetAuditOrderDetail
 * @name: WithdrawAuditOrderDetailRsp
 */
export interface WithdrawAuditOrderDetailRsp {
  /**
   * 商户ID
   */
  tenantId: number;
   ...
   * 
   */
  withdrawState: WithdrawStateEnum;
  /**
   * 实际到账金额
   */
  actualAmount: number;
   ...
   * 
   */
  bankCardDetail: BankCardDetailRsp;
  /**
   * 可选出款通道列表（Key=商户通道ID，Value=通道展示名称）
   */
  withdrawChannelList: Record<string, string>;
}

export type WithdrawAuditOrderDetailRspApiResponse = WithdrawAuditOrderDetailRsp;

/**
 * @description: 0 - 待审核 1 - 审核中
 */
export type WithdrawAuditStateEnum = 0 | 1;

/**
 * @description: 新增三方银行映射记录 (Auth) 请求
 * @url: /api/WithdrawConfig/AddBankMapping
 * @name: WithdrawBankMappingAddReq
 */
export interface WithdrawBankMappingAddReq {
  /**
   * 通道ID
   */
  channelId?: number;
...
/**
 * @description: 软删除三方银行映射记录 (Auth) 请求
 * @url: /api/WithdrawConfig/DeleteBankMapping
 * @name: WithdrawBankMappingDeleteReq
 */
export interface WithdrawBankMappingDeleteReq {
  /**
   * 记录ID
   */
  id?: number;
...
/**
 * @description: 编辑三方银行映射记录 (Auth) 请求
 * @url: /api/WithdrawConfig/EditBankMapping
 * @name: WithdrawBankMappingEditReq
 */
export interface WithdrawBankMappingEditReq {
  /**
   * 记录ID
   */
  id?: number;
...
export interface WithdrawBankMappingImportRsp {
  /**
   * 行号（从1开始，不含表头）
   */
  rowNo: number;
...
/**
 * @description: 批量导入CSV（格式：ChannelId,BankName,ThirdCode，第一行为表头） (Auth) 响应
 * @url: /api/WithdrawConfig/BatchImportBankMapping
 * @name: WithdrawBankMappingImportRspListApiResponse
 */
export type WithdrawBankMappingImportRspListApiResponse = WithdrawBankMappingImportRsp[];

/**
 * @description: 分页查询三方银行映射数据 (Auth) 请求
 * @url: /api/WithdrawConfig/GetBankMappingPageList
 * @name: WithdrawBankMappingPageReq
 */
export interface WithdrawBankMappingPageReq {
  /**
   * 三方映射码（精确匹配）
   */
  payCode?: string;
...
export interface WithdrawBankMappingPageRsp {
  /**
   * 记录ID
   */
  id: number;
...
/**
 * @description: 分页查询三方银行映射数据 (Auth) 响应
 * @url: /api/WithdrawConfig/GetBankMappingPageList
 * @name: WithdrawBankMappingPageRspListPageBaseResponse
 */
export interface WithdrawBankMappingPageRspListPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: WithdrawBankMappingPageRsp[];
  /**
   * 当前页
   */
  pageNo: number;
...
export type WithdrawBankMappingPageRspListPageBaseResponseApiResponse = WithdrawBankMappingPageRspListPageBaseResponse;

/**
 * @description: 获取提现大类详情 (Auth) 响应
 * @url: /api/WithdrawCategory/Get
 * @name: WithdrawCategoryDetailRsp
 */
export interface WithdrawCategoryDetailRsp {
  /**
   * 
   */
  id: number;
   ...
   * 
   */
  feeAmountRangeMin: number;
  /**
   * 
   */
  feeAmountRangeMax: number;
  /**
   * 
   */
  feeType: number;
...
export type WithdrawCategoryDetailRspApiResponse = WithdrawCategoryDetailRsp;

/**
 * @description: 1 - 银行卡 2 - UPI 3 - USDT 4 - 电子钱包 5 - PIX 6 - WavePay 8 - KBZPay 21 - ARPay 23 - Easypaisa 24 - JAZZCASH 27 - FAST-UPI
 */
export type WithdrawCategoryEnum = 1 | 2 | 3 | 4 | 5 | 6 | 8 | 21 | 23 | 24 | 27;

/**
 * @description: 获取提现大类详情 (Auth) 请求
 * @url: /api/WithdrawCategory/Get
 * @name: WithdrawCategoryGetReq
 */
export interface WithdrawCategoryGetReq {
  /**
   * 
   */
  id?: number;
...
/**
 * @description: 分页查询提现大类列表(如果V3无数据则先从V1同步) (Auth) 请求
 * @url: /api/WithdrawCategory/GetPageList
 * @name: WithdrawCategoryListReq
 */
export interface WithdrawCategoryListReq {
  /**
   * 提现大类(前台显示名称)
   */
  customName?: string;
...
export interface WithdrawCategoryListRsp {
  /**
   * 
   */
  id: number;
...
/**
 * @description: 分页查询提现大类列表(如果V3无数据则先从V1同步) (Auth) 响应
 * @url: /api/WithdrawCategory/GetPageList
 * @name: WithdrawCategoryListRspListPageBaseResponse
 */
export interface WithdrawCategoryListRspListPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: WithdrawCategoryListRsp[];
  /**
   * 当前页
   */
  pageNo: number;
...
export type WithdrawCategoryListRspListPageBaseResponseApiResponse = WithdrawCategoryListRspListPageBaseResponse;

/**
 * @description: 变更状态(双写V1+V3) (Auth) 请求
 * @url: /api/WithdrawCategory/UpdateState
 * @name: WithdrawCategoryStateReq
 */
export interface WithdrawCategoryStateReq {
  /**
   * 
   */
  id?: number;
...
/**
 * @description: 编辑提现大类(双写V1+V3) (Auth) 请求
 * @url: /api/WithdrawCategory/Update
 * @name: WithdrawCategoryUpdateReq
 */
export interface WithdrawCategoryUpdateReq {
  /**
   * 
   */
  id?: number;
...
/**
 * @description: 获取今日提现总次数配置(优先读V3，降级V1) (Auth) 响应
 * @url: /api/WithdrawCategory/GetWithCount
 * @name: WithdrawCategoryWithCountRsp
 */
export interface WithdrawCategoryWithCountRsp {
  /**
   * 今日提现总次数配置
   */
  withCount: number;
...
export type WithdrawCategoryWithCountRspApiResponse = WithdrawCategoryWithCountRsp;

/**
 * @description: 设置今日提现总次数配置(双写V1+V3，刷新V1缓存) (Auth) 请求
 * @url: /api/WithdrawCategory/SetWithCount
 * @name: WithdrawCategoryWithCountSetReq
 */
export interface WithdrawCategoryWithCountSetReq {
  /**
   * 今日提现总次数配置
   */
  withCount?: number;
...
/**
 * @description: 批量新增提现通道 (Auth) 请求
 * @url: /api/WithdrawChannel/BatchAdd
 * @name: WithdrawChannelBatchAddReq
 */
export interface WithdrawChannelBatchAddReq {
  /**
   * 商户ID
   */
  tenantId: number;
...
/**
 * @description: 获取提现通道详情 (Auth) 响应
 * @url: /api/WithdrawChannel/Get
 * @name: WithdrawChannelDetailRsp
 */
export interface WithdrawChannelDetailRsp {
  /**
   * 排序
   */
  sort: number;
  ...
  thirdChannelCode: string;
  /**
   * 通道币种(WithdrawChannelEntity.SysCurrency)
   */
  sysCurrency: string;
  /**
  ...
  state: number;
  /**
   * 通道状态(1:开启, 0:关闭) - tab_withdraw_channel.State
   */
  channelState: number;
  /**
   * 自动出款权重
  ...
  autoCloseBalance: number;
  /**
   * 三方通道余额(ThirdPayMerchantEntity.Balance)
   */
  thirdBalance: number;
  /**
   * 余额最后更新时间(ThirdPayMerchantEntity.BalanceUpdateTime)
   */
...
export type WithdrawChannelDetailRspApiResponse = WithdrawChannelDetailRsp;

/**
 * @description: 获取提现通道字典详情 (Auth) 响应
 * @url: /api/WithdrawChannelDictionary/Get
 * @name: WithdrawChannelDictionaryDetailRsp
 */
export interface WithdrawChannelDictionaryDetailRsp {
  /**
   * ID
   */
  id: number;
...
export type WithdrawChannelDictionaryDetailRspApiResponse = WithdrawChannelDictionaryDetailRsp;

/**
 * @description: 提现通道字典分页查询 (Auth) 请求
 * @url: /api/WithdrawChannelDictionary/GetPageList
 * @name: WithdrawChannelDictionaryListReq
 */
export interface WithdrawChannelDictionaryListReq {
  /**
   * 通道名称
   */
  name?: string;
...
/**
 * @description: 修改提现通道字典 (Auth) 请求
 * @url: /api/WithdrawChannelDictionary/Update
 * @name: WithdrawChannelDictionaryModelReq
 */
export interface WithdrawChannelDictionaryModelReq {
  /**
   * 主键
   */
  id: number;
...
export interface WithdrawChannelDictionaryRsp {
  /**
   * ID
   */
  id: number;
...
/**
 * @description: 提现通道字典分页查询 (Auth) 响应
 * @url: /api/WithdrawChannelDictionary/GetPageList
 * @name: WithdrawChannelDictionaryRspListPageBaseResponse
 */
export interface WithdrawChannelDictionaryRspListPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: WithdrawChannelDictionaryRsp[];
  /**
   * 当前页
   */
  pageNo: number;
...
export type WithdrawChannelDictionaryRspListPageBaseResponseApiResponse = WithdrawChannelDictionaryRspListPageBaseResponse;

export interface WithdrawChannelGroupRsp {
  /**
   * 厂商编码
   */
  payCode: string;
   ...
   * 该PayCode下的通道列表
   */
  channels: WithdrawChannelNameRsp[];
}

/**
 * @description: 获取代付通道信息（PayCode → List<Id, Name>，无需权限） (Auth) 响应
 * @url: /api/WithdrawConfig/GetWithdrawChannelGroupList
 * @name: WithdrawChannelGroupRspListApiResponse
 */
export type WithdrawChannelGroupRspListApiResponse = WithdrawChannelGroupRsp[];

/**
 * @description: 提现通道分页查询 (Auth) 请求
 * @url: /api/WithdrawChannel/GetPageList
 * @name: WithdrawChannelListReq
 */
export interface WithdrawChannelListReq {
  /**
   * 商户ID
   */
  tenantId: number;
...
/**
 * @description: 修改提现通道 (Auth) 请求
 * @url: /api/WithdrawChannel/Update
 * @name: WithdrawChannelModelReq
 */
export interface WithdrawChannelModelReq {
  /**
   * 主键(新增时为0，编辑时>0)
   */
  id?: number;
...
export interface WithdrawChannelNameRsp {
  /**
   * 通道ID
   */
  id: number;
...
export interface WithdrawChannelRsp {
  /**
   * 主键ID
   */
  id: number;
...
/**
 * @description: 提现通道分页查询 (Auth) 响应
 * @url: /api/WithdrawChannel/GetPageList
 * @name: WithdrawChannelRspListPageBaseResponse
 */
export interface WithdrawChannelRspListPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: WithdrawChannelRsp[];
  /**
   * 当前页
   */
  pageNo: number;
...
export type WithdrawChannelRspListPageBaseResponseApiResponse = WithdrawChannelRspListPageBaseResponse;

export interface WithdrawChannelTestBankInfoRsp {
  /**
   * 币种
   */
  currency: string;
...
/**
 * @description: 获取测试提现资料 (Auth) 响应
 * @url: /api/WithdrawChannel/GetTestWithdrawCategory
 * @name: WithdrawChannelTestBankInfoRspListApiResponse
 */
export type WithdrawChannelTestBankInfoRspListApiResponse = WithdrawChannelTestBankInfoRsp[];

/**
 * @description: 代付测试拉单 (Auth) 响应
 * @url: /api/WithdrawChannel/TestCreateWithdrawOrder
 * @name: WithdrawChannelTestRsp
 */
export interface WithdrawChannelTestRsp {
  /**
   * 订单号
   */
  orderNo: string;
...
export type WithdrawChannelTestRspApiResponse = WithdrawChannelTestRsp;

/**
 * @description: 提现订单异常消除（重置异常/提交中的三方状态） (Auth) 请求
 * @url: /api/WithdrawOrder/ClearException
 * @name: WithdrawClearExceptionReq
 */
export interface WithdrawClearExceptionReq {
  /**
   * 提现订单号
   */
  orderNo: string;
...
出款员工操作台也使用了该地址 (Auth) 响应
 * @url: /api/WithdrawConfigGroup/Get
 * @name: WithdrawConfigGroupDetailRsp
 */
export interface WithdrawConfigGroupDetailRsp {
  /**
   * 主键
   */
  id: number;
   ...
   * 订单派发模式
   */
  orderDispatchMode: string;
  /**
   * 规则多语言列表
   */
  translationList: WithdrawConfigGroupTranslationRsp[];
  /**
   * 单人同时处理订单上限
   */
  concurrentOrderLimitPerUser: number;
  /**
   * 已派发订单不审核超时时间(分钟)
   */
  unAuditOrderTimeoutDuration: number;
  /**
   * 已审核订单多久未完成超时时间(分钟)
   */
  auditedOrderTimeoutDuration: number;
  /**
   * 员工暂停时长上限(分钟)
   */
  maxUserPauseDuration: number;
  /**
   * 超时提醒规则
   */
  timeoutAlertRule: string;
  /**
   * 暂停规则
   */
  pauseRule: string;
   ...
   * 订单处理规则
   */
  orderHandlingRule: string;
  /**
   * 绑定用户列表
   */
  userList: WithdrawConfigGroupUserRsp[];
}

export type WithdrawConfigGroupDetailRspApiResponse = WithdrawConfigGroupDetailRsp;

/**
 * @description: 获取出款派单配置组别列表（分页） (Auth) 请求
 * @url: /api/WithdrawConfigGroup/GetPageList
 * @name: WithdrawConfigGroupListReq
 */
export interface WithdrawConfigGroupListReq {
  /**
   * 组别名称（选填，模糊匹配）
   */
  groupName?: string;
...
/**
 * @description: 新增出款派单配置组别 (Auth) 请求
 * @url: /api/WithdrawConfigGroup/Add
 * @name: WithdrawConfigGroupModelReq
 */
export interface WithdrawConfigGroupModelReq {
  /**
   * 主键（新增时不传或为0，编辑时必填）
   */
  id?: number;
   ...
   * 规则多语言列表
   */
  translationList?: WithdrawConfigGroupTranslationReq[];
  /**
   * 单人同时处理订单上限
   */
  concurrentOrderLimitPerUser?: number;
...
export interface WithdrawConfigGroupRsp {
  /**
   * 主键
   */
  id: number;
...
/**
 * @description: 获取出款派单配置组别列表（分页） (Auth) 响应
 * @url: /api/WithdrawConfigGroup/GetPageList
 * @name: WithdrawConfigGroupRspListPageBaseResponse
 */
export interface WithdrawConfigGroupRspListPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: WithdrawConfigGroupRsp[];
  /**
   * 当前页
   */
  pageNo: number;
...
export type WithdrawConfigGroupRspListPageBaseResponseApiResponse = WithdrawConfigGroupRspListPageBaseResponse;

export interface WithdrawConfigGroupTranslationReq {
  /**
   * 语言代码
   */
  languageCode?: string;
...
export interface WithdrawConfigGroupTranslationRsp {
  /**
   * 主键
   */
  id: number;
...
export interface WithdrawConfigGroupUserRsp {
  /**
   * 用户ID
   */
  userId: number;
...
/**
 * @description: 按组别ID获取组内用户列表 (Auth) 响应
 * @url: /api/WithdrawConfigGroup/GetUsersByGroupId
 * @name: WithdrawConfigGroupUserRspListApiResponse
 */
export type WithdrawConfigGroupUserRspListApiResponse = WithdrawConfigGroupUserRsp[];

/**
 * @description: 人工取消出款 (Auth) 请求
 * @url: /api/WithdrawOrder/ManualCancel
 * @name: WithdrawManualCancelReq
 */
export interface WithdrawManualCancelReq {
  /**
   * 提现订单号
   */
  orderNo: string;
...
/**
 * @description: 人工确认出款 (Auth) 请求
 * @url: /api/WithdrawOrder/ManualConfirm
 * @name: WithdrawManualConfirmReq
 */
export interface WithdrawManualConfirmReq {
  /**
   * 提现订单号
   */
  orderNo: string;
...
export interface WithdrawOrderAuditDetailRecordRsp {
  /**
   * 序号
   */
  sort: number;
  ...
  createTime: number;
  /**
   * 三方状态(SysEventLog.ExtendLong3, 写入时操作时订单的 ThirdStateEnum)
   */
  thirdState: number;
  /**
   * 商户通道ID(SysEventLog.ExtendLong2, 写入时操作所用通道)
   */
  tenantChannelId: number;
  /**
   * 内容
...
export interface WithdrawOrderAuditDetailRsp {
  /**
   * 审核记录列表
   */
  recordList: WithdrawOrderAuditDetailRecordRsp[];
}

export interface WithdrawOrderAuditPageListRsp {
  /**
   * 商户Id
   */
  tenantId: number;
   ...
   * 
   */
  auditDetail: WithdrawOrderAuditDetailRsp;
  /**
   * 出款状态编码
   */
...
/**
 * @description: 获取已操作的订单明细 (Auth) 响应
 * @url: /api/WithdrawOrder/GetAuditPageList
 * @name: WithdrawOrderAuditPageListRspListWithdrawOrderSummaryRspPageBaseResponse
 */
export interface WithdrawOrderAuditPageListRspListWithdrawOrderSummaryRspPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: WithdrawOrderAuditPageListRsp[];
  /**
   * 
   */
  summary: WithdrawOrderSummaryRsp;
  /**
   * 当前页
   */
  pageNo: number;
...
export type WithdrawOrderAuditPageListRspListWithdrawOrderSummaryRspPageBaseResponseApiResponse = WithdrawOrderAuditPageListRspListWithdrawOrderSummaryRspPageBaseResponse;

/**
 * @description: 获取已操作的订单明细 (Auth) 请求
 * @url: /api/WithdrawOrder/GetAuditPageList
 * @name: WithdrawOrderAuditPageReq
 */
export interface WithdrawOrderAuditPageReq {
  /**
   * 商户Id
   */
  tenantId?: number;
   ...
   * 最小提现次数
   */
  minTotalWithdrawCount?: number;
  /**
   * 最大提现次数
   */
  maxTotalWithdrawCount?: number;
  /**
   * 最小申请金额
   */
  minAmount?: number;
   ...
   * 
   */
  dateType?: WithdrawOrderDateTypeEnum;
  /**
   * 开始时间，13位时间戳
   */
  startTime?: number;
...
/**
 * @description: 获取已处理订单审核记录列表 (Auth) 请求
 * @url: /api/WithdrawOrder/GetAuditRecordList
 * @name: WithdrawOrderAuditRecordListReq
 */
export interface WithdrawOrderAuditRecordListReq {
  /**
   * 提现单号
   */
  withdrawNo: string;
...
export interface WithdrawOrderAuditRecordRsp {
  /**
   * 序号
   */
  sort: number;
...
/**
 * @description: 获取已处理订单审核记录列表 (Auth) 响应
 * @url: /api/WithdrawOrder/GetAuditRecordList
 * @name: WithdrawOrderAuditRecordRspListApiResponse
 */
export type WithdrawOrderAuditRecordRspListApiResponse = WithdrawOrderAuditRecordRsp[];

/**
 * @description: 0 - OrderCreateTime 1 - LastUpdateTime 2 - SubmittedTime
 */
export type WithdrawOrderDateTypeEnum = 0 | 1 | 2;

export interface WithdrawOrderListRsp {
  /**
   * 订单号
   */
  orderNo: string;
...
/**
 * @description: 获取处理中订单分页列表 (Auth) 响应
 * @url: /api/WithdrawOrder/GetProcessingOrderPageList
 * @name: WithdrawOrderListRspListWithdrawOrderSummaryRspPageBaseResponse
 */
export interface WithdrawOrderListRspListWithdrawOrderSummaryRspPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: WithdrawOrderListRsp[];
  /**
   * 
   */
  summary: WithdrawOrderSummaryRsp;
...
export type WithdrawOrderListRspListWithdrawOrderSummaryRspPageBaseResponseApiResponse = WithdrawOrderListRspListWithdrawOrderSummaryRspPageBaseResponse;

/**
 * @description: 获取已处理订单明细分页列表 (Auth) 请求
 * @url: /api/WithdrawOrder/GetPageList
 * @name: WithdrawOrderPageReq
 */
export interface WithdrawOrderPageReq {
  /**
   * 商户ID集合，逗号分隔，如：1001,1002
   */
  tenantIds?: string;
  /**
   * 订单号
...
export interface WithdrawOrderSummaryRsp {
  /**
   * 订单总数
   */
   ...
   * 打码倍数合计
   */
  totalThisCodingAmount: number;
}

/**
 * @description: 预留获取已处理订单第三方记录列表 (Auth) 请求
 * @url: /api/WithdrawOrder/GetThirdPartyRecordList
 * @name: WithdrawOrderThirdPartyRecordListReq
 */
export interface WithdrawOrderThirdPartyRecordListReq {
  /**
   * 订单号
   */
  orderNo: string;
...
/**
 * @description: 预留获取已处理订单第三方记录列表 (Auth) 响应
 * @url: /api/WithdrawOrder/GetThirdPartyRecordList
 * @name: WithdrawOrderThirdPartyRecordListRsp
 */
export interface WithdrawOrderThirdPartyRecordListRsp {
  /**
   * 提交三方次数
   */
  paidOutCount: number;
   ...
   * 第三方记录列表
   */
  recordList: WithdrawOrderThirdPartyRecordRsp[];
}

export type WithdrawOrderThirdPartyRecordListRspApiResponse = WithdrawOrderThirdPartyRecordListRsp;

export interface WithdrawOrderThirdPartyRecordRsp {
  /**
   * 序号
   */
  sort: number;
  ...
  /**
   * 提现通道Id(SysEventLog.ExtendLong2, 写入时操作所用 TenantChannelId)
   */
  channelId: number;
  /**
   * 
...
/**
 * @description: 获取处理中订单分页列表 (Auth) 请求
 * @url: /api/WithdrawOrder/GetProcessingOrderPageList
 * @name: WithdrawProcessingOrderPageReq
 */
export interface WithdrawProcessingOrderPageReq {
  /**
   * 订单号
   */
  orderNo?: string;
...
export interface WithdrawRecordListRsp {
  /**
   * 商户ID
   */
  tenantId: number;
...
/**
 * @description: 获取提现记录分页列表 (Auth) 响应
 * @url: /api/WithdrawRecord/GetPageList
 * @name: WithdrawRecordListRspListWithdrawRecordSummaryRspPageBaseResponse
 */
export interface WithdrawRecordListRspListWithdrawRecordSummaryRspPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: WithdrawRecordListRsp[];
  /**
   * 
   */
  summary: WithdrawRecordSummaryRsp;
  /**
   * 当前页
   */
  pageNo: number;
...
export type WithdrawRecordListRspListWithdrawRecordSummaryRspPageBaseResponseApiResponse = WithdrawRecordListRspListWithdrawRecordSummaryRspPageBaseResponse;

/**
 * @description: 获取提现记录分页列表 (Auth) 请求
 * @url: /api/WithdrawRecord/GetPageList
 * @name: WithdrawRecordPageReq
 */
export interface WithdrawRecordPageReq {
  /**
   * 会员ID，支持短ID或长ID
   */
  userId?: number;
   ...
   * 最小提现倍数
   */
  minThisCodingAmount?: number;
  /**
   * 最大提现倍数
   */
  maxThisCodingAmount?: number;
  /**
   * 申请开始时间，13位时间戳
   */
...
export interface WithdrawRecordSummaryRsp {
  /**
   * 页面订单数
   */
...
/**
 * @description: 更新提现记录备注 (Auth) 请求
 * @url: /api/WithdrawRecord/UpdateRemark
 * @name: WithdrawRecordUpdateRemarkReq
 */
export interface WithdrawRecordUpdateRemarkReq {
  /**
   * 创建时间，13位时间戳
   */
  createTime?: number;
...
/**
 * @description: 提现订单重审（重置已提交订单回到待审核状态） (Auth) 请求
 * @url: /api/WithdrawOrder/ResetOrderToWait
 * @name: WithdrawResetOrderReq
 */
export interface WithdrawResetOrderReq {
  /**
   * 提现订单号
   */
  orderNo: string;
...
/**
 * @description: 开始审核提现订单 (Auth) 请求
 * @url: /api/WithdrawUser/WithdrawalStartAudit
 * @name: WithdrawStartAuditReq
 */
export interface WithdrawStartAuditReq {
  /**
   * 提现订单号
   */
  orderNo: string;
...
/**
 * @description: 0 - 待审核 1 - 已通过 2 - 已拒绝 3 - 已提交
 */
export type WithdrawStateEnum = 0 | 1 | 2 | 3;

/**
 * @description: 矫正员工上下班时间 (Auth) 请求
 * @url: /api/WithdrawStaticDay/CorrectWorkTime
 * @name: WithdrawStaticdayCorrectWorkTimeReq
 */
export interface WithdrawStaticdayCorrectWorkTimeReq {
  /**
   * 系统用户ID
   */
  sysUserId: number;
...
export interface WithdrawStaticdayDailyDetailRsp {
  /**
   * 统计日期
   */
  reportDate: string;
   ...
   * 处理中单数
   */
  handlingOrderCount: number;
  /**
   * 转出单数
   */
  transOutOrderCount: number;
  /**
   * 转入单数
   */
  transInOrderCount: number;
  /**
   * 审核平均耗时，单位秒
   */
   ...
   * 未审核订单超时次数
   */
  unAuditTimeoutTimes: number;
  /**
   * 审核订单超时订单数
   */
  auditedTimeoutOrderCount: number;
  /**
   * 主动暂停总次数
   */
  totalSelfPauseTimes: number;
  /**
   * 超时暂停总次数
   */
  totalSystemPauseTimes: number;
  /**
   * 暂停总时长，单位秒
   */
   ...
   * 是否允许矫正上下班时间
   */
  canCorrectWorkTime: boolean;
}

/**
 * @description: 获取出款工作台看板数据 (Auth) 响应
 * @url: /api/WithdrawStaticDay/GetDashboardData
 * @name: WithdrawStaticdayDashboardRsp
 */
export interface WithdrawStaticdayDashboardRsp {
  /**
   * 在线出款人数
   */
  onlineStaffCount: string;
  /**
   * 暂停中人数
   */
  pausedStaffCount: string;
  /**
   * 处理中订单单数
   */
  processingOrderCount: string;
  /**
   * 待派发订单单数
   */
  pendingDispatchOrderCount: string;
  /**
   * 今日已出款单数
   */
  todayTransOutOrderCount: string;
  /**
   * 今日已完成单数
   */
  todayCompletedOrderCount: string;
  /**
   * 今日平均处理时长
   */
  todayAvgHandleDuration: string;
  /**
   * 今日审核订单超时预警数
   */
  todayAuditTimeoutWarningCount: string;
  /**
   * 今日员工暂停超时预警数
   */
  todayPauseTimeoutWarningCount: string;
}

export type WithdrawStaticdayDashboardRspApiResponse = WithdrawStaticdayDashboardRsp;

/**
 * @description: 获取出款员工每日统计数据 (Auth) 请求
 * @url: /api/WithdrawStaticDay/GetDailyStatistics
 * @name: WithdrawStaticdayDetailReq
 */
export interface WithdrawStaticdayDetailReq {
  /**
   * 系统用户ID
   */
  sysUserId: number;
...
/**
 * @description: 获取出款员工每日统计数据 (Auth) 响应
 * @url: /api/WithdrawStaticDay/GetDailyStatistics
 * @name: WithdrawStaticdayDetailRsp
 */
export interface WithdrawStaticdayDetailRsp {
  /**
   * 
   */
  userInfo: WithdrawStaticdayUserInfoRsp;
  /**
   * 
   */
  summary: WithdrawStaticdaySummaryRsp;
  /**
   * 每日明细列表
   */
  dailyDetails: WithdrawStaticdayDailyDetailRsp[];
}

export type WithdrawStaticdayDetailRspApiResponse = WithdrawStaticdayDetailRsp;

export interface WithdrawStaticdayListRsp {
  /**
   * 系统用户ID
   */
  sysUserId: number;
   ...
   * 平均暂停时长文本
   */
  avgPauseDurationText: string;
}

/**
 * @description: 获取出款员工报表列表 (Auth) 响应
 * @url: /api/WithdrawStaticDay/GetPageList
 * @name: WithdrawStaticdayListRspListPageBaseResponse
 */
export interface WithdrawStaticdayListRspListPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: WithdrawStaticdayListRsp[];
  /**
   * 当前页
   */
  pageNo: number;
...
export type WithdrawStaticdayListRspListPageBaseResponseApiResponse = WithdrawStaticdayListRspListPageBaseResponse;

/**
 * @description: 获取出款员工报表列表 (Auth) 请求
 * @url: /api/WithdrawStaticDay/GetPageList
 * @name: WithdrawStaticdayPageReq
 */
export interface WithdrawStaticdayPageReq {
  /**
   * 开始日期
   */
  startWorkTime: string;
...
export interface WithdrawStaticdaySummaryRsp {
  /**
   * 已完成单数
   */
  auditedOrderCount: number;
...
export interface WithdrawStaticdayUserInfoRsp {
  /**
   * 系统用户ID
   */
  sysUserId: number;
...
/**
 * @description: 提交三方出款 (Auth) 请求
 * @url: /api/WithdrawOrder/SubmitThirdPay
 * @name: WithdrawSubmitThirdPayReq
 */
export interface WithdrawSubmitThirdPayReq {
  /**
   * 商户通道关系表主键(tab_thirdpay_tenantchannel.Id)
   */
  tenantChannelId: number;
  /**
   * 提现订单号
...
export interface WithdrawTenantUserRsp {
  /**
   * 商户ID
   */
  tenantId: number;
...
/**
 * @description: 获取当前用户可出款商户与用户关系 (Auth) 响应
 * @url: /api/WithdrawUser/GetWithdrawTenantsWithUser
 * @name: WithdrawTenantUserRspListApiResponse
 */
export type WithdrawTenantUserRspListApiResponse = WithdrawTenantUserRsp[];

/**
 * @description: 1 - 上班打卡 2 - 下班打卡 3 - 开始接单 4 - 手动暂停接单 5 - 恢复但不接单 6 - 恢复并接单
 */
export type WithdrawUserActionEnum = 1 | 2 | 3 | 4 | 5 | 6;

/**
 * @description: 出款员工操作（上班/下班/开始接单/暂停/恢复） (Auth) 请求
 * @url: /api/WithdrawUser/WorkAction
 * @name: WithdrawUserActionReq
 */
export interface WithdrawUserActionReq {
  /**
   * 
   */
  action: WithdrawUserActionEnum;
}

/**
 * @description: 0 - 组员 1 - 组长 2 - 主管 3 - 管理员
 */
export type WithdrawUserRankEnum = "组员" | "组长" | "主管" | "管理员";

export interface WithdrawUserSelectItemRsp {
  /**
   * 用户ID
   */
  userId: number;
...
/**
 * @description: 获取出款用户下拉列表（指派组长 / 转派订单） (Auth) 响应
 * @url: /api/WithdrawUser/GetStaffUserSelectList
 * @name: WithdrawUserSelectItemRspListApiResponse
 */
export type WithdrawUserSelectItemRspListApiResponse = WithdrawUserSelectItemRsp[];

/**
 * @description: 获取出款用户下拉列表（指派组长 / 转派订单） (Auth) 请求
 * @url: /api/WithdrawUser/GetStaffUserSelectList
 * @name: WithdrawUserSelectListReq
 */
export interface WithdrawUserSelectListReq {
  /**
   * 
   */
  type: WithdrawUserSelectTypeEnum;
  /**
   * 订单号列表（仅 Type=TransferOrder 时使用，按订单的币种 + 提现大类筛选可指派的目标用户）
   */
  orderNos?: string[];
}

/**
 * @description: 1 - 指派组长 2 - 转派订单
 */
export type WithdrawUserSelectTypeEnum = 1 | 2;

export interface WithdrawWarningPageListRsp {
  /**
   * 预警记录ID(19位长整型；序列化时输出字符串避免 JS Number 精度丢失)
   */
  id: number;
  /**
   * 预警时间(13位毫秒时间戳)
...
/**
 * @description: 获取出款异常风控预警分页列表 (Auth) 响应
 * @url: /api/WithdrawStaticDay/GetWithdrawWarningList
 * @name: WithdrawWarningPageListRspListPageBaseResponse
 */
export interface WithdrawWarningPageListRspListPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: WithdrawWarningPageListRsp[];
  /**
   * 当前页
   */
  pageNo: number;
...
export type WithdrawWarningPageListRspListPageBaseResponseApiResponse = WithdrawWarningPageListRspListPageBaseResponse;

/**
 * @description: 获取出款异常风控预警分页列表 (Auth) 请求
 * @url: /api/WithdrawStaticDay/GetWithdrawWarningList
 * @name: WithdrawWarningPageReq
 */
export interface WithdrawWarningPageReq {
  /**
   * 
   */
  warningType?: WarningTypeEnum;
  ...
  warningStatus?: WarningStatusEnum;
  /**
   * 预警开始时间(13位毫秒时间戳，可选；不传时按近一个月查询命中分区)
   */
  startTime?: number;
  /**
   * 预警结束时间(13位毫秒时间戳，可选)
...
/**
 * @description: 解除异常记录(异常风控预警列表的"解除异常"按钮：把指定预警记录置为已处理；如该员工还在因此异常状态中，顺带恢复) (Auth) 请求
 * @url: /api/WithdrawStaticDay/RecoverExceptionRecord
 * @name: WithdrawWarningRecordOperateReq
 */
export interface WithdrawWarningRecordOperateReq {
  /**
   * 预警记录ID(19位长整型；接受字符串或数字两种入参格式)
   */
  id?: number;
}

export interface WithdrawWorkCurrentOrderListRsp {
  /**
   * 订单号
   */
  orderNo: string;
   ...
   * 
   */
  userWithdrawType: WithdrawCategoryEnum;
  /**
   * 实际到账金额
   */
  actualAmount: number;
   ...
   * 
   */
  thirdPartyState: ThirdStateEnum;
  /**
   * 三方消息
   */
...
/**
 * @description: 获取当前提现订单分页列表 (Auth) 响应
 * @url: /api/WithdrawOrder/GetCurrentWithdrawOrderList
 * @name: WithdrawWorkCurrentOrderListRspListPageBaseResponse
 */
export interface WithdrawWorkCurrentOrderListRspListPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: WithdrawWorkCurrentOrderListRsp[];
  /**
   * 当前页
   */
  pageNo: number;
...
export type WithdrawWorkCurrentOrderListRspListPageBaseResponseApiResponse = WithdrawWorkCurrentOrderListRspListPageBaseResponse;

/**
 * @description: 获取当前提现订单分页列表 (Auth) 请求
 * @url: /api/WithdrawOrder/GetCurrentWithdrawOrderList
 * @name: WithdrawWorkCurrentOrderPageReq
 */
export interface WithdrawWorkCurrentOrderPageReq {
  /**
   * 订单号
   */
  orderNo?: string;
   ...
   * 
   */
  sysCategoryId?: WithdrawCategoryEnum;
  /**
   * 币种
   */
  sysCurrency?: string;
  ...
  endDate?: number;
  /**
   * 完成开始时间，13位时间戳，过滤 LastUpdateTime
   */
  completeStartDate?: number;
  /**
   * 完成结束时间，13位时间戳，过滤 LastUpdateTime
   */
  completeEndDate?: number;
  /**
   * 处理状态（前端传枚举英文名，支持多选）
   */
  processState?: WithdrawWorkProcessStateEnum[];
  /**
   * 默认排序字段
   */
  sortField?: string;
...
/**
 * @description: 1 - 待派发 2 - 待审核 3 - 审核中 4 - 审核超时
 */
export type WithdrawWorkProcessStateEnum = "待派发" | "待审核" | "审核中" | "审核超时";

/**
 * @description: 获取员工实时状态分页列表 (Auth) 请求
 * @url: /api/WithdrawOrder/GetStaffRealTimeStateList
 * @name: WithdrawWorkStaffRealTimeStatePageReq
 */
export interface WithdrawWorkStaffRealTimeStatePageReq {
  /**
   * 状态过滤（前端传枚举英文名，支持多选）
   */
  state?: WithdrawWorkStateEnum[];
  /**
   * 员工账号ID
   */
  userId?: number;
...
export interface WithdrawWorkStaffRealTimeStateRsp {
  /**
   * 商户ID集合
   */
  tenantIds: string;
   ...
   * 未审核订单超时次数
   */
  unAuditTimeoutCount: number;
  /**
   * 审核订单超时次数
   */
  auditTimeoutCount: number;
  /**
   * 上班时间
   */
  startWorkTime: number;
...
/**
 * @description: 获取员工实时状态分页列表 (Auth) 响应
 * @url: /api/WithdrawOrder/GetStaffRealTimeStateList
 * @name: WithdrawWorkStaffRealTimeStateRspListPageBaseResponse
 */
export interface WithdrawWorkStaffRealTimeStateRspListPageBaseResponse {
  /**
   * 获取 返回数据
   */
  list: WithdrawWorkStaffRealTimeStateRsp[];
  /**
   * 当前页
   */
  pageNo: number;
...
export type WithdrawWorkStaffRealTimeStateRspListPageBaseResponseApiResponse = WithdrawWorkStaffRealTimeStateRspListPageBaseResponse;

/**
 * @description: 0 - 未上班 1 - 上班(未开启接单) 2 - 上班(接单中) 3 - 上班(管理设置暂停接单) 4 - 上班(主动暂停中) 5 - 上班(暂停超时异常) 7 - 上班(未审核超时异常)
 */
export type WithdrawWorkStateEnum = "未上班" | "上班(未开启接单)" | "上班(接单中)" | "上班(管理设置暂停接单)" | "上班(主动暂停中)" | "上班(暂停超时异常)" | "上班(未审核超时异常)";

/**
 * @description: 批量导入CSV（格式：ChannelId,BankName,ThirdCode，第一行为表头） (Auth) 请求
 * @url: /api/WithdrawConfig/BatchImportBankMapping
 * @name: BatchImportBankMappingFormDto
 */
export interface BatchImportBankMappingFormDto {
  /**
   * 
   */
  file?: string;
