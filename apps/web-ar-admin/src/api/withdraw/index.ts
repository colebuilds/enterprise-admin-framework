...
export const getWithdrawCategoryEnumList = () => {
  return requestClient.post<IdNameRspListApiResponse>(
    '/WithdrawCategory/GetWithdrawCategoryEnumList',
  );
};
 ...
 */
export const getChannelWithdrawCategoryEnumList = (
  params: ChannelDictionaryCategoryEnumListReq,
) => {
  return requestClient.post<IdNameRspListApiResponse>(
    '/WithdrawCategory/GetChannelWithdrawCategoryEnumList',
    params,
  );
};
...
export const getSelectList = (params: MasterApiRequest) => {
  return requestClient.post<IdNameRspListApiResponse>(
    '/WithdrawCategory/GetSelectList',
    params,
  );
};
...
export const getWithCount = (params: MasterApiRequest) => {
  return requestClient.post<WithdrawCategoryWithCountRsp>(
    '/WithdrawCategory/GetWithCount',
    params,
  );
};
 ...
 */
export const withdrawCategoryGetPageList = (
  params: WithdrawCategoryListReq,
) => {
  return requestClient.post<WithdrawCategoryListRspListPageBaseResponse>(
    '/WithdrawCategory/GetPageList',
    params,
  );
};
/**
 ...
 * @url: /api/WithdrawCategory/GetPageList
 */
export const withdrawCategoryGetPageListExport = (
  params: WithdrawCategoryListReq,
) => {
  return requestClient.post<Blob>('/WithdrawCategory/GetPageList', params, {
    responseType: 'blob',
  });
};
...
export const withdrawCategoryGet = (params: WithdrawCategoryGetReq) => {
  return requestClient.post<WithdrawCategoryDetailRsp>(
    '/WithdrawCategory/Get',
    params,
  );
};
 ...
 */
export const withdrawCategoryUpdateState = (
  params: WithdrawCategoryStateReq,
) => {
...
export const testCreateWithdrawOrder = (params: TestCreateWithdrawOrderReq) => {
  return requestClient.post<WithdrawChannelTestRsp>(
    '/WithdrawChannel/TestCreateWithdrawOrder',
    params,
  );
};
...
export const testWithdrawNotify = (params: TestWithdrawNotifyReq) => {
  return requestClient.post<WithdrawChannelTestRsp>(
    '/WithdrawChannel/TestWithdrawNotify',
    params,
  );
};
...
export const getMerchantChannelTree = (params: MerchantChannelTreeReq) => {
  return requestClient.post<MerchantChannelTreeWrapperRsp>(
    '/WithdrawChannel/GetMerchantChannelTree',
    params,
  );
};
...
export const withdrawChannelGet = (params: IdReq) => {
  return requestClient.post<WithdrawChannelDetailRsp>(
    '/WithdrawChannel/Get',
    params,
  );
};
...
export const withdrawChannelGetPageList = (params: WithdrawChannelListReq) => {
  return requestClient.post<WithdrawChannelRspListPageBaseResponse>(
    '/WithdrawChannel/GetPageList',
    params,
  );
};
/**
 ...
 * @url: /api/WithdrawChannel/GetPageList
 */
export const withdrawChannelGetPageListExport = (
  params: WithdrawChannelListReq,
) => {
  return requestClient.post<Blob>('/WithdrawChannel/GetPageList', params, {
    responseType: 'blob',
  });
};
 ...
 */
export const getTestCurrencyWithdrawType = (
  params: GetTestCurrencyWithdrawTypeReq,
) => {
  return requestClient.post<IdNameRspListApiResponse>(
    '/WithdrawChannel/GetTestCurrencyWithdrawType',
    params,
  );
};
...
export const getTestWithdrawCategory = (params: GetTestWithdrawCategoryReq) => {
  return requestClient.post<WithdrawChannelTestBankInfoRspListApiResponse>(
    '/WithdrawChannel/GetTestWithdrawCategory',
    params,
  );
};
 ...
 */
export const getTestWithdrawBankCategoryInfo = (
  params: GetTestWithdrawBankCategoryInfoReq,
) => {
  return requestClient.post<WithdrawChannelTestBankInfoRspListApiResponse>(
    '/WithdrawChannel/GetTestWithdrawBankCategoryInfo',
    params,
  );
};
 ...
 */
export const testQueryThirdChannelBalance = (
  params: TestQueryThirdChannelBalanceReq,
) => {
  return requestClient.post<WithdrawChannelTestRsp>(
    '/WithdrawChannel/TestQueryThirdChannelBalance',
    params,
  );
};
...
export const testCheckWithdrawOrder = (params: TestCheckWithdrawOrderReq) => {
  return requestClient.post<WithdrawChannelTestRsp>(
    '/WithdrawChannel/TestCheckWithdrawOrder',
    params,
  );
};
 ...
 */
export const withdrawChannelDictionaryUpdate = (
  params: WithdrawChannelDictionaryModelReq,
) => {
 ...
 */
export const withdrawChannelDictionaryUpdateState = (
  params: UpdateStateReq,
) => {
  return requestClient.post<any>(
    '/WithdrawChannelDictionary/UpdateState',
    params,
  );
};
...
export const withdrawChannelDictionaryGet = (params: IdReq) => {
  return requestClient.post<WithdrawChannelDictionaryDetailRsp>(
    '/WithdrawChannelDictionary/Get',
    params,
  );
};
 ...
 */
export const withdrawChannelDictionaryGetPageList = (
  params: WithdrawChannelDictionaryListReq,
) => {
  return requestClient.post<WithdrawChannelDictionaryRspListPageBaseResponse>(
    '/WithdrawChannelDictionary/GetPageList',
    params,
  );
};
/**
 ...
 * @url: /api/WithdrawChannelDictionary/GetPageList
 */
export const withdrawChannelDictionaryGetPageListExport = (
  params: WithdrawChannelDictionaryListReq,
) => {
...
export const getWithdrawChannelGroupList = () => {
  return requestClient.post<WithdrawChannelGroupRspListApiResponse>(
    '/WithdrawConfig/GetWithdrawChannelGroupList',
  );
};
...
export const getBankMappingPageList = (params: WithdrawBankMappingPageReq) => {
  return requestClient.post<WithdrawBankMappingPageRspListPageBaseResponse>(
    '/WithdrawConfig/GetBankMappingPageList',
    params,
  );
};
/**
 ...
 * @url: /api/WithdrawConfig/GetBankMappingPageList
 */
export const getBankMappingPageListExport = (
  params: WithdrawBankMappingPageReq,
) => {
  return requestClient.post<Blob>(
    '/WithdrawConfig/GetBankMappingPageList',
    params,
 ...
 */
export const batchImportBankMapping = (
  file: File,
  params: Omit<BatchImportBankMappingFormDto, 'file'>,
) => {
  return uploadFile<WithdrawBankMappingImportRspListApiResponse>(
    { url: '/WithdrawConfig/BatchImportBankMapping' },
    { files: [file], ...params },
    'file',
  );
};
 ...
 */
export const withdrawConfigGroupUpdate = (
  params: WithdrawConfigGroupModelReq,
) => {
...
export const withdrawConfigGroupGet = (params: IdReq) => {
  return requestClient.post<WithdrawConfigGroupDetailRsp>(
    '/WithdrawConfigGroup/Get',
    params,
  );
};
 ...
 */
export const withdrawConfigGroupGetPageList = (
  params: WithdrawConfigGroupListReq,
) => {
  return requestClient.post<WithdrawConfigGroupRspListPageBaseResponse>(
    '/WithdrawConfigGroup/GetPageList',
    params,
  );
};
/**
 ...
 * @url: /api/WithdrawConfigGroup/GetPageList
 */
export const withdrawConfigGroupGetPageListExport = (
  params: WithdrawConfigGroupListReq,
) => {
  return requestClient.post<Blob>('/WithdrawConfigGroup/GetPageList', params, {
    responseType: 'blob',
  });
};
...
export const getUsersByGroupId = (params: IdReq) => {
  return requestClient.post<WithdrawConfigGroupUserRspListApiResponse>(
    '/WithdrawConfigGroup/GetUsersByGroupId',
    params,
  );
};
...
export const getOrderDispatchModeEnumList = () => {
  return requestClient.post<IdNameRspListApiResponse>(
    '/WithdrawConfigGroup/GetOrderDispatchModeEnumList',
  );
};
...
export const getMyAuditOrderList = (params: MyAuditOrderPageReq) => {
  return requestClient.post<MyAuditOrderListRspListPageBaseObjResponse>(
    '/WithdrawOrder/GetMyAuditOrderList',
    params,
  );
};
/**
 ...
 */
export const getStaffRealTimeStateList = (
  params: WithdrawWorkStaffRealTimeStatePageReq,
) => {
  return requestClient.post<WithdrawWorkStaffRealTimeStateRspListPageBaseResponse>(
    '/WithdrawOrder/GetStaffRealTimeStateList',
    params,
  );
};
/**
 ...
 * @url: /api/WithdrawOrder/GetStaffRealTimeStateList
 */
export const getStaffRealTimeStateListExport = (
  params: WithdrawWorkStaffRealTimeStatePageReq,
) => {
  return requestClient.post<Blob>(
    '/WithdrawOrder/GetStaffRealTimeStateList',
 ...
 */
export const getProcessingOrderPageList = (
  params: WithdrawProcessingOrderPageReq,
) => {
  return requestClient.post<WithdrawOrderListRspListWithdrawOrderSummaryRspPageBaseResponse>(
    '/WithdrawOrder/GetProcessingOrderPageList',
    params,
  );
};
/**
 ...
 * @url: /api/WithdrawOrder/GetProcessingOrderPageList
 */
export const getProcessingOrderPageListExport = (
  params: WithdrawProcessingOrderPageReq,
) => {
  return requestClient.post<Blob>(
    '/WithdrawOrder/GetProcessingOrderPageList',
 ...
 */
export const getCurrentWithdrawOrderList = (
  params: WithdrawWorkCurrentOrderPageReq,
) => {
  return requestClient.post<WithdrawWorkCurrentOrderListRspListPageBaseResponse>(
    '/WithdrawOrder/GetCurrentWithdrawOrderList',
    params,
  );
};
/**
 ...
 * @url: /api/WithdrawOrder/GetCurrentWithdrawOrderList
 */
export const getCurrentWithdrawOrderListExport = (
  params: WithdrawWorkCurrentOrderPageReq,
) => {
  return requestClient.post<Blob>(
    '/WithdrawOrder/GetCurrentWithdrawOrderList',
...
export const getAuditOrderDetail = (params: WithdrawAuditOrderDetailReq) => {
  return requestClient.post<WithdrawAuditOrderDetailRsp>(
    '/WithdrawOrder/GetAuditOrderDetail',
    params,
  );
};
 ...
 * @url: /api/WithdrawOrder/GetPageList
 */
export const withdrawOrderGetPageListExport = (
  params: WithdrawOrderPageReq,
) => {
  return requestClient.post<Blob>('/WithdrawOrder/GetPageList', params, {
    responseType: 'blob',
  });
};
...
export const getAuditPageList = (params: WithdrawOrderAuditPageReq) => {
  return requestClient.post<WithdrawOrderAuditPageListRspListWithdrawOrderSummaryRspPageBaseResponse>(
    '/WithdrawOrder/GetAuditPageList',
    params,
  );
};
/**
...
export const getAuditPageListExport = (params: WithdrawOrderAuditPageReq) => {
  return requestClient.post<Blob>('/WithdrawOrder/GetAuditPageList', params, {
    responseType: 'blob',
  });
};
...
export const getAuditRecordList = (params: WithdrawOrderAuditRecordListReq) => {
  return requestClient.post<WithdrawOrderAuditRecordRspListApiResponse>(
    '/WithdrawOrder/GetAuditRecordList',
    params,
  );
};
 ...
 */
export const getThirdPartyRecordList = (
  params: WithdrawOrderThirdPartyRecordListReq,
) => {
  return requestClient.post<WithdrawOrderThirdPartyRecordListRsp>(
    '/WithdrawOrder/GetThirdPartyRecordList',
    params,
  );
};
...
export const withdrawRecordGetPageList = (params: WithdrawRecordPageReq) => {
  return requestClient.post<WithdrawRecordListRspListWithdrawRecordSummaryRspPageBaseResponse>(
    '/WithdrawRecord/GetPageList',
    params,
  );
};
/**
 ...
 * @url: /api/WithdrawRecord/GetPageList
 */
export const withdrawRecordGetPageListExport = (
  params: WithdrawRecordPageReq,
) => {
  return requestClient.post<Blob>('/WithdrawRecord/GetPageList', params, {
    responseType: 'blob',
  });
};
 ...
 */
export const withdrawStaticDayGetPageList = (
  params: WithdrawStaticdayPageReq,
) => {
  return requestClient.post<WithdrawStaticdayListRspListPageBaseResponse>(
    '/WithdrawStaticDay/GetPageList',
    params,
  );
};
/**
 ...
 * @url: /api/WithdrawStaticDay/GetPageList
 */
export const withdrawStaticDayGetPageListExport = (
  params: WithdrawStaticdayPageReq,
) => {
  return requestClient.post<Blob>('/WithdrawStaticDay/GetPageList', params, {
    responseType: 'blob',
  });
};
...
export const getDashboardData = (params: SearchTenantIdsRequest) => {
  return requestClient.post<WithdrawStaticdayDashboardRsp>(
    '/WithdrawStaticDay/GetDashboardData',
    params,
  );
};
...
export const getWithdrawWarningList = (params: WithdrawWarningPageReq) => {
  return requestClient.post<WithdrawWarningPageListRspListPageBaseResponse>(
    '/WithdrawStaticDay/GetWithdrawWarningList',
    params,
  );
};
/**
 ...
 * @url: /api/WithdrawStaticDay/GetWithdrawWarningList
 */
export const getWithdrawWarningListExport = (
  params: WithdrawWarningPageReq,
) => {
  return requestClient.post<Blob>(
    '/WithdrawStaticDay/GetWithdrawWarningList',
    params,
...
export const getOrderPoolWarningConfig = () => {
  return requestClient.post<OrderPoolWarningConfigRsp>(
    '/WithdrawStaticDay/GetOrderPoolWarningConfig',
  );
};
 ...
 */
export const saveOrderPoolWarningConfig = (
  params: SaveOrderPoolWarningConfigReq,
) => {
  return requestClient.post<any>(
    '/WithdrawStaticDay/SaveOrderPoolWarningConfig',
    params,
  );
};
 ...
 */
export const recoverExceptionRecord = (
  params: WithdrawWarningRecordOperateReq,
) => {
  return requestClient.post<any>(
    '/WithdrawStaticDay/RecoverExceptionRecord',
    params,
  );
};
...
export const getDailyStatistics = (params: WithdrawStaticdayDetailReq) => {
  return requestClient.post<WithdrawStaticdayDetailRsp>(
    '/WithdrawStaticDay/GetDailyStatistics',
    params,
  );
};
 ...
 */
export const correctWorkTime = (
  params: WithdrawStaticdayCorrectWorkTimeReq,
) => {
...
export const getWithdrawTenantsWithUser = () => {
  return requestClient.post<WithdrawTenantUserRspListApiResponse>(
    '/WithdrawUser/GetWithdrawTenantsWithUser',
  );
};
...
export const getStaffUserSelectList = (params: WithdrawUserSelectListReq) => {
  return requestClient.post<WithdrawUserSelectItemRspListApiResponse>(
    '/WithdrawUser/GetStaffUserSelectList',
    params,
  );
};
...
export const getSysUserWorkDetail = () => {
  return requestClient.post<SysUserWorkDetailRsp>(
    '/WithdrawUser/GetSysUserWorkDetail',
  );
};
